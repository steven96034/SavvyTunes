...
import com.example.geminispotifyapp.data.di.WeatherInfoGist
import com.example.geminispotifyapp.data.remote.model.WeatherIconInfo
...
@Singleton
class WeatherIconRepositoryImpl @Inject constructor(
     ...
     */
    override fun getWeatherDisplayInfo(wmoCode: Int, isDay: Boolean): Pair<String?, String?> {
