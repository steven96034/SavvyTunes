...
//
//            val refreshToken = appDatabase.getRefreshToken()
//            Log.d("RefreshToken", "Find saved refreshToken when ready to refresh: $refreshToken")
//            val clientId = BuildConfig.SPOTIFY_WEB_API_KEY
//            if (refreshToken.isNullOrEmpty()) {
//                Log.d("RefreshToken", "Empty Refresh Token")
//                return
//            }
...
//            appDatabase.saveRefreshToken(response.refreshToken)
//            Log.d("RefreshToken", "Save new refresh token: $refreshToken")
//
//            Log.d("SpotifyData", "Successfully refreshed Access Token")
//        } catch (e: Exception) {
//            Log.e("SpotifyData", "Failed to refresh Access Token", e)
//            throw e
//        }
//    }
